			...
			$this->Header .= "
				<div class=\"jumbotron\">
		            <section class=\"container\">
		                <div class=\"row\">
		                    <h1>Each link leads to a webpage that displays specific data depending on the query.</h1>
		                </div>
		                <div class=\"row\">
		                ...
		                <div class=\"row\">
		                    <div class=\"col-sm-3\">
		                        <div class=\"row\" id=\"Quote\">
		                            <a href=\"http://web.njit.edu/~jmm77/is218/Twitter/index.php?page=printtimeline\" class=\"btn btn-md btn-block btn-success\">Colleges that have the highest enrollment</a>
